        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <section class="content">
                    ...
                    <div class="sucesss_alert_bar alert alert-success bs-alert-old-docs " id="sucesss_alert_bar" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <!-- Location column -->
                        <form role="form" id="form_item" method="POST">
                            <!-- left column -->   
                            <div class="col-md-6">
                                ...
                                <div class="box box-warning">
                                    <div class="box-body">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <input type="text" readonly name="location" class="form-control" value="Free2Vape.CO.UK" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="txt_description" rows="3" placeholder="Tasty cofee ups for affordable price">
                                                    <?php  if(isset($itemData->name)){ echo trim($itemData->description);} ?>
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="col-xs-4"><input type="text" size="10" name="quantity" value="<?php  if(isset($itemData->name)){ echo $itemData->quantity;} ?>" class="form-control" placeholder="# Quantity"/></div>
                                                <div class="col-xs-4"> <input type="text" size="10" value="<?php  if(isset($itemData->name)){ echo $itemData->reorder_level;} ?>" name="reorder_level" class="form-control" placeholder="# Reorder level"/> </div>
                                            ...
                                            <div class="form-group">
                                                <label>Price</label>
                                               <input type="text" name="price" class="form-control col-xs-4"  value="<?php  if(isset($itemData->name)){ echo $itemData->price;} ?>" placeholder="£ 10.00"/>
                                            </div>
                                            <br/><br/>
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="box box-warning">
                                    ...
                                    <div class="box-footer">
                                        <input type="hidden" size="10" name="item_code" value="<?= $itemData->item_code ?>" />
...
$(document).ready(function() { 
    ...
    $('#form_item').validate({
            ...
            //removed all default space in txt areas
            $('textarea#txt_description').html($('textarea#txt_description').html().trim());
});
</script>
