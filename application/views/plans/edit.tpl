                                ...
                                <div class="box box-warning">
                                    <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label> Name</label>
                                                <input type="text" name="name" class="form-control" value="<?= $plans_data->name ?>"  placeholder="New Cofee Ltd"/>
                                            </div>
                                            <div class="form-group">
                                                <label> Description</label>
                                                <textarea class="form-control" name="description" rows="3" placeholder="Tasty cofee ups for affordable price">
                                                     <?= $plans_data->description ?>
                                                </textarea>
                                            </div>
                                            ...
                                            <label>Inventory</label>
                                                ...
                                                <div class="col-xs-4"><input type="text" size="10" name="quantity" value="<?= $plans_data->quantity ?>"  class="form-control" placeholder="# Quantity"/></div>
                                            ...
                                            <div class="form-group">
                                                <label>Price</label>
                                               <input type="text" name="price" class="form-control col-xs-4"  value="<?= $plans_data->price ?>"  placeholder="£ 10.00"/>
                                            </div>
                                ...
                                <div class="box box-warning">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                               ...
                                               <input type="text" name="frequency" class="form-control col-xs-4"  value="<?= $plans_data->frequency ?>" />
                                            </div>

                                            <div class="form-group">
                                                <label>Start Date</label>
                                               <input type="text" id=""  name="start_date" value="<?= $plans_data->start_date ?>"  class="form-control col-xs-4 setData"  />
                                            </div>

                                            <div class="form-group">
                                                <label>End Date</label>
                                               <input type="text" name="end_date" class="form-control col-xs-4 setData" value="<?= $plans_data->end_date ?>" />
                                            </div>
                                    ...
                                    <div class="box-footer">
                                         <input type="hidden" size="10" name="plan_id" value="<?= $plans_data->plan_id ?>" />
...
$(document).ready(function() { 
    ...
    $('#form_item').validate({
                ...
                submitHandler: function (form) {
                     $.ajax({
                          type: "POST",
                          url: "<?php echo base_url('index.php/plans/update_plans'); ?>",
