...
<head>
	...
	<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/reset.css"  media="print"/>
...
<div id="menubar">
	<div id="menubar_container">
		...
		<span style='font-size:8pt;'><?php echo $this->lang->line('common_powered_by').' PlusPro'; ?></span>
	</div>
   ...
   <ul>
            ...
            <li>
				...
				<div class="menu_text"><a href="<?php echo site_url("$module->module_id");?>"><?php echo $this->lang->line("module_".$module->module_id) ?></a></div>
                <div style="clear:both;"></div>
...
<div align="center" class="store_name"><?php echo $this->config->item('company'); ?> - <?php echo $this->session->userdata('shop_name'); ?></div>
