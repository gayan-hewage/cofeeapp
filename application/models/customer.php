...
{	
	...
	*/
	function exists($person_id)
	{
		...
		$this->db->where('customers.source',$this->session->userdata('source'));
		$query = $this->db->get();
	...
	*/
	function get_all($limit=10000, $offset=0)
	{
		...
		$this->db->where('source',$this->session->userdata('source'));			
	...
	*/
	function get_search_suggestions($search,$source,$limit=25)
	{
		$suggestions = array();
